...
* @file: The name of the file buffer which stores the char.
*
...
*incorrect the exit code is 97.
* If the file_from does not exist or
*cannot be read the exit code is  98.
* If the file_to cannot be created or
*written to the exit code is 99.
* If the file_to or file_from cannot be
*closed the exit code is 100.
*/
